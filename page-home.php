...
get_header(); ?>
	...
	<?php while ( have_posts() ) : the_post(); ?>
		...
		<div class="container">
		  ...
		  <div class="sixteen columns">
		    <div class="headlineHP">LEARN TODAY, LEAD TOMORROW!</div>
		  </div>

		  <div class="one-third column">
		    <a href="/women"><div class="circular1"></div></a>
		    <p></p>
		    <div class="textCenter"><h2><a href="/women">Women's College</a></h2>
		    <p>The College of Saint Elizabeth develops leadership skills and knowledge in a holistic, liberal arts institution.  Our women's college has great resources in an intimate setting.</p></div>
		  </div>    
		  
		  <div class="one-third column">
		   	<a href="/continuing"><div class="circular2"></div></a>
		    <p></p>
		    <div class="textCenter"><h2><a href="/continuing">Continuing Studies</a></h2>
		    <p>Honing skills and furthering professional potential both in the classroom and online, our continuing education programs offer flexibility and value real-world experience.</p></div>
		  </div>

		  <div class="one-third column">
		   	<a href="/graduate"><div class="circular3"></div></a>
		    <p></p>
		    <div class="textCenter"><h2><a href="/graduate">Graduate Studies</a></h2>
		    <p>With an overarching ethos of social justice, our higher degrees offer specialization in key academic areas, and approach scholarship as a window into the human experience.</p></div>
		  </div>  
		</div><!-- container -->
		  ...
		  <div class="container">
		    <div class="one-third column">
		      ...
		      <h4>LOCAL HOTEL ACCOMMODATIONS</h4>
		      <p>For best rates, please use our online reservation system to book your hotel overnight stays. Be sure to ask for the CSE preferred rate.<br /><a href="/localhotels"><b>BOOK HOTEL</b></a><br /><br /></p>
		      <h4>EMERGENCY NOTIFICATIONS</h4>
		      <p>With the winter season upon us, there is no better time to sign up for emergency notifications via our automated phone and text messaging system.<br /><br /> Sign up for a Send Word Now account today to get updates on weather alerts, class cancellations or emergencies at a moment's notice.<br /><a href="/sendwordnow"><b>LEARN MORE</b></a></p>
		    </div>
		  <div class="one-third column">
